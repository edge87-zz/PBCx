pbcx : main.o AudioController.o Game.o Player.o scon.o Switch.o SwitchHandler.o WikiMode.o LogController.o LightController.o VideoController.o SerialController.o
	g++ -o pbcx main.o AudioController.o Game.o Player.o scon.o Switch.o SwitchHandler.o WikiMode.o LogController.o LightController.o VideoController.o SerialController.o -lrt -lpthread $(shell sdl-config --libs) $(shell sdl-config --cflags) -lSDL_ttf -lvlc -lSDL_mixer
